...
def add_samson_simulator(simulator):
        '''
...
pathToPyScript = os.path.realpath(__file__)
SAMSON.importFromFile(os.path.dirname(pathToPyScript) + '/Cyclopropane.pdb', '')
...
add_samson_simulator(simulator)         # add the simulator to the active layer in the active document in SAMSON
